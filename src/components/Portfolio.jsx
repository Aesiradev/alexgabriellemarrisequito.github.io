...
const projects = [
  ...
  {
    previews: [
      `${BASE}assets/images/Dashboard-RF.png`,
      `${BASE}assets/images/Carousel-RF.png`,
      `${BASE}assets/images/Results-RF.png`,
    ],
    number: "03",
    title: "Restaurant Finder",
    tag: "Web App",
    status: "Completed",
    description: "AI powered restaurant finder.",
    tech: ["TypeScript", "ReactJS", "TailWind CSS", "Node.js", "Claude API", "Foursquare API"],
    github: "#",
    live: null,
  },
];
